...
router.post(
  '/:threadId/upvote',
  isAuthenticated,
  ThreadController.toggleUpvoteThread,
);
router.post(
  '/:threadId/downvote',
  isAuthenticated,
  ThreadController.toggleDownvoteThread,
);
...
router.post(
  '/:threadId/comments',
  isAuthenticated,
  validateThreadCommentFields,
  ThreadCommentController.createComment,
);

router.get(
  '/:threadId/comments/:commentId',
  ThreadCommentController.getComment,
);
router.put(
  '/:threadId/comments/:commentId',
  isAuthenticated,
  validateThreadCommentFields,
  ThreadCommentController.updateComment,
);
router.post(
  '/:threadId/comments/:commentId/view',
  ThreadCommentController.viewComment,
);
router.post(
  '/:threadId/comments/:commentId/upvote',
  isAuthenticated,
  ThreadCommentController.toggleUpvoteComment,
);
router.post(
  '/:threadId/comments/:commentId/downvote',
  isAuthenticated,
  ThreadCommentController.toggleDownvoteComment,
);

    ...
    for (const fieldName in validationSchema) {
      if (Object.prototype.hasOwnProperty.call(validationSchema, fieldName)) {
        ...
        if (!Array.isArray(fieldValidatorOrValidators)) {
          ...
          const fieldValidator = fieldValidatorOrValidators as FieldValidator<
        ...
        const fieldValidators = fieldValidatorOrValidators as FieldValidator<
          TFields[keyof TFields]
        >[];
...
const runFormValidators = <TFields extends FormFields>(
  ...
  try {
    ...
    const formValidators =
      formValidatorOrValidators as FormValidator<TFields>[];
